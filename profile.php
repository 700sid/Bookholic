...
<?php    
    ...
    $sql="SELECT count(id) as total from books where Seller_Name='$username'";
...
<div class=" col-md-12 jumbotron" style="padding:15px">
  <h1>Your Books</h1>
  <p>All ayour Books are listed here Delete Them after they Sold</p>
</div>
<div class="row">
<?php
...
if ($_GET['pageno']){
  ...
  $offset = ($current_page-1)*20;
    ...
    $sql = "SELECT * FROM books where Seller_Name='$username' LIMIT 20 OFFSET $offset";
    $run = mysqli_query($con,$sql);
    ...
    <img src="data:image/jpeg;base64,'.base64_encode( $result['image'] ).'"/>
       ...
       <div class = "caption">
        ...
        <p> Uploaded for :<b>',$result['saledon'],'</b></p>
        ...
        <p>
           <a href = "detail.php?id=',$result['id'],'" class = "btn btn-primary" role = "button">
            ...
            <a href = "db/delete.php?id=',$result['id'],'" class = "btn btn-danger" role = "button" onclick="return confirm(',$prompt,')">
                 Delete
              </a>
...
<div class="row">
<div class="d-flex p-2" style=" bottom:0; text-align:center">
<nav aria-label="Page navigation example" style="text-align:center">
 ...
 if($totalpage%20==0){
  ...
  echo '<li class="page-item"><a class="page-link" href="profile.php?pageno=',$current_page-1,'">Previous</a></li>';
  ...
  for($i=1;$i<=$totalpage;$i++) {
    ...
    echo '<li class="page-item"><a class="page-link" href="profile.php?pageno=',$i,'">',$i,'</a></li>';
   }  }
   if ($current_page==$totalpage){
    echo '<li class="page-item disabled"><a class="page-link" tabindex="-1">Next</a></li>';
  }
  else
  echo '<li class="page-item"><a class="page-link" href="profile.php?pageno=',$current_page+1,'">Next</a></li>';
