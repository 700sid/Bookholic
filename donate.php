...
<?php    
    $sql="SELECT count(id) as total from books where saledon='donate'";
...
$sql = "SELECT * FROM books where saledon='donate' LIMIT 20 OFFSET $offset";
$run = mysqli_query($con,$sql);
...
?>
 ...
 if($totalpage%20==0){
  ...
  echo '<li class="page-item"><a class="page-link" href="donate.php?pageno=',$current_page-1,'">Previous</a></li>';
  ...
  for($i=1;$i<=$totalpage;$i++) {
    ...
    echo '<li class="page-item"><a class="page-link" href="donate.php?pageno=',$i,'">',$i,'</a></li>';
   }  }
   if ($current_page==$totalpage){
    echo '<li class="page-item disabled"><a class="page-link" tabindex="-1">Next</a></li>';
  }
  else
  echo '<li class="page-item"><a class="page-link" href="donate.php?pageno=',$current_page+1,'">Next</a></li>';
